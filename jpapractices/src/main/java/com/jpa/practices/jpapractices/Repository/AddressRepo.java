...
public interface AddressRepo extends JpaRepository<Address, Integer> {
    ...
    @Query(nativeQuery = true, value = "SELECT ea.id, ea.city, ea.state FROM jparepo.address ea join jparepo.employee e on e.id = ea.employee_id where ea.employee_id=:employeeId")
